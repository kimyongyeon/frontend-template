...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _world = __webpack_require__(332);
	...
	window.addEventListener('popstate', function (e) {
	    ...
	    _route.Route.router(e.state.path);
	});
	...
	navigation.addEventListener('click', function (e) {
	    ...
	    _route.Route.router(path);
	});
	
	_route.Route.router('/');
	
	document.getElementById('output').innerHTML = 'Hello ' + _world2.default + '!';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _about2 = __webpack_require__(334);
	...
	var _service2 = __webpack_require__(337);
	...
	var routes = {
	    '/': function _() {
	        Route.renderHtml('' + _home2.default);
	    },
	    '/service': function service() {
	        Route.renderHtml('' + _service3.default);
	    },
	    '/about': function about() {
	        Route.renderHtml('' + _about3.default);
	    },
	    otherwise: function otherwise(path) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function AboutService() {
	    var resultResp = _jQuery2.default.ajax("https://jsonplaceholder.typicode.com/posts?userId=1");
